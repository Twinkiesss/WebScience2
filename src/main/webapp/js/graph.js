        ...
        marks.forEach(mark => {
            ...
            if (mark.val !== 0) {
                ...
                if (mark.val < 0) {
                    ...
                    markXNeg.setAttribute('x1', this.CENTER_X + scaled); // Используем scaled с учетом знака
            ...
            if (mark.val !== 0) {
                ...
                if (mark.val < 0) {
                    ...
                    markYNeg.setAttribute('y1', this.CENTER_Y - scaled); // Используем scaled с учетом знака
